<section class="">
    <header>
        <h4>
            ...
            Domain Wizard
            <small>Setup your Basic www Settings in 3 Easy Steps!</small>
        </h4>
    </header>
    <div class="body">
        <div id="wizard" class="form-wizard">
            <ul class="wizard-navigation nav-justified">
                <li><a href="#tab1" data-toggle="tab"><b>1.</b> <strong> <i class="fa fa-globe"></i> Super {$HTTP_HOST}</strong></a></li>
                <!-- <li><a href="#tab2" data-toggle="tab"><b>2.</b> <strong><i class="fa fa-globe"></i> Super Sub Domains</strong></a></li> -->
                <li><a href="#tab2" data-toggle="tab"><small>3.</small> <strong><i class="fa fa-ge"></i> Super NeXus</strong></a></li>
                <li><a href="#tab4" data-toggle="tab"><b>3.</b> <strong><i class="fa fa-check"></i> Complete!</strong></a></li>
            </ul>
            ...
            <div class="tab-content">
                <div class="description">
                    <ul class="pager wizard">
                        <li class="previous">
                            <button class="btn btn-primary btn-lg pull-left"><i class="fa fa-caret-left"></i> Previous</button>
                        </li>
                        <li class="next">
                            <button class="btn btn-primary  btn-lg pull-right" >Next <i class="fa fa-caret-right"></i></button>
                        </li>
                        <li class="finish" style="display: none">
                            <button class="btn btn-success  btn-lg pull-right" >Finish <i class="fa fa-check"></i></button>
                        </li>
                    </ul>
                </div>
                        ...
                        <fieldset>
                            <div class="control-group">
                                ...
                                <div class="controls form-group">
                                    <div class="col-md-10">
                                        <input type="text" id="website_name" name="username" placeholder="" class="form-control">
                            ...
                            <div class="control-group">
                                <!-- Email -->
                                <label class="control-label"  for="email">Meta Tags</label>
                                <div class="controls form-group">
                                    <div class="col-md-10">
